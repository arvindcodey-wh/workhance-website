...
function Banner({ type }) {
  const isAboutUs = type === "about us";
  const [currentImageIndex, setCurrentImageIndex] = useState(0);

 
  const images = [
    "https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&q=80", // Modern Office
    "https://images.unsplash.com/photo-1522071820081-009f0129c71c?auto=format&fit=crop&q=80", // Collaborative Team
    "https://images.unsplash.com/photo-1519389950473-47ba0277781c?auto=format&fit=crop&q=80", // Tech & Strategy
  ];
  ...
  return (
    <div className="w-full h-[450px] md:h-[550px] relative overflow-hidden flex items-center justify-center bg-slate-900">
      ...
      {/* 3. Sliding Background Images with Cross-Fade */}
      {images.map((img, index) => (
        ...
        >
          ...
          />
          {/* Sky Blue Tint Overlay to match your brand */}
