...
function ApplicationForm() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      if (!res.ok) {
        setSubmitError(
          data.message || "User already applied to this job."
        );
        return;
      }
  ...
  if (isSubmitted) {
    return (
      <div className="animate-fadeIn flex w-[90%] md:w-[60%] lg:w-[70%] items-center flex-col mx-auto  py-10 bg-white rounded-3xl shadow-xl border border-sky-100 text-center px-10 my-10">
        ...
        >
          ...
          <div className="flex flex-col w-full">
            ...
            <input
              ...
              value={job?.title || ""}
              readOnly
              className="border border-gray-200 rounded-xl p-3 focus:outline-none"
            />
          </div>
          ...
          <button
            type="submit"
           className="w-full bg-sky-500 text-white py-4 rounded-xl font-bold text-lg flex items-center justify-center gap-2"
          >
            Send Application
